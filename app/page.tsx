    ...
    <main className="relative min-h-screen font-sans selection:bg-[#43A047] selection:text-white overflow-x-hidden">
            ...
            {SERVICES.map((srv, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1 z-10 -mt-6">
                  ...
                  <p className={`text-sm leading-relaxed mb-4 flex-1 font-medium ${srv.type === 'premium' ? 'text-white/90' : 'text-gray-600'}`}>
                    {srv.descCourte}
                  </p>
      ...
      <footer className="bg-[#1A1A1A] py-16 text-center relative overflow-hidden z-20">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {/* Téléphone */}
          <a href="tel:+33777777787" className="inline-flex items-center gap-2 text-white font-bold text-lg hover:text-[#43A047] transition-colors duration-300 mb-6">
          ...
          <div className="flex items-center justify-center gap-5 mb-8">
            <a href="https://www.facebook.com/share/18sZZCTTyB/" target="_blank" rel="noopener noreferrer" aria-label="Facebook DS HY'LEC" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#1877F2] flex items-center justify-center transition-all duration-300 hover:scale-110">
            ...
            <a href="https://www.instagram.com/ds_hylec?igsh=cTZycDd1c2VyYTFn" target="_blank" rel="noopener noreferrer" aria-label="Instagram DS HY'LEC" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#C13584] flex items-center justify-center transition-all duration-300 hover:scale-110">
            ...
            <a href="https://www.tiktok.com/@ds.hylec?_r=1&_t=ZN-97aMukDyPxu" target="_blank" rel="noopener noreferrer" aria-label="TikTok DS HY'LEC" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#010101] flex items-center justify-center transition-all duration-300 hover:scale-110">
              <svg viewBox="0 0 24 24" fill="currentColor" style={{width:'20px', height:'20px'}} className="text-white">
